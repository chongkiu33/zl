    ...
    <div> 
        ...
        <div className={styles.spChapter}>
            ...
            <div className={styles.spChapterText}>
                ...
                <div><TextSplitter text={`However, this story has many variations throughout history, and here’s my reference for making the story: https://sites.pitt.edu/~dash/hameln.html#grimm245 `}/></div>
