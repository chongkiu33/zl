  ...
  return (
    <div> 
        ...
        <div className={styles.spChapter}>
          ...
          <div className={styles.spChapterText}>
            <Link className={styles.link} target="_blank" href="https://kooshoo.com/pages/about">KooShoo </Link>
            <Link className={styles.link} target="_blank" href="https://alexanderclementine.com/products/seaweed-scrunchie?variant=37378936701090">Seaweed Scrunchie</Link>
          </div>
        </div>
        ...
        <div className={styles.spChapter}>
          ...
          <div className={styles.spChapterText}>
                ...
                <Link className={styles.link} target="_blank" href="https://www.healthline.com/health/ponytail-headache#What-causes-a-ponytail-headache?">Ponytail Headache: Why It Happens and How to Get Relief</Link>
          </div>
        </div>
...
However, it is expensive as the 6 hair ties cost $39.
        ...
        <ul>
        <div>Reference</div>
        <li><Link className={styles.link} target="_blank" href="https://www.purewow.com/beauty/best-hair-ties">We Tried Every Single Hair Tie and Ranked Them from “Best” to “Get Off My Wrist”</Link></li>
        <li><Link className={styles.link} target="_blank" href="https://burlybands.com/blogs/news/scrunchies-vs-elastic-hair-ties-choosing-the-best-hair-accessory-for-thick-hair">Scrunchies vs Elastic Hair Ties: Choosing the Best Hair Accessory for Thick Hair</Link></li>
        <li><Link className={styles.link} target="_blank" href="https://soulvationsociety.com/blogs/soulvation-society/understanding-hair-ties-your-top-questions-answered">Understanding Hair Ties: Your Top Questions Answered</Link></li>
        </ul>
        ...
        <div className={styles.spChapter}>
            ...
            <div className={styles.spChapterText}>
            <Link className={styles.link} target="_blank" href="https://materiom.org/">materiom.org</Link>
            
            
            <ul>
            <strong>Agar Agar</strong>
            <TextSplitter text={`(adding more glycerin will increase the softness/flexibility)`} />
            <li><Link className={styles.link} target="_blank" href="https://pubmed.ncbi.nlm.nih.gov/22340685/">Scientific research for properties of agar agar</Link></li>
            <li><Link className={styles.link} target="_blank" href="https://www.youtube.com/watch?v=Ty0O2VmbNeE">Video tutorial for making biomaterial with agar agar</Link></li>
            </ul>
            ...
            <li><Link className={styles.link} target="_blank" href="https://www.youtube.com/watch?v=FE_ps20YHro">Video tutorial for making biomaterial with gelatin</Link></li>
            ...
            <li><Link className={styles.link} target="_blank" href="https://www.youtube.com/watch?v=_sz0KkT603E">Video tutorial for making stretchable biomaterial with hydrogels</Link></li>
            ...
            <div>
           <Link className={styles.link} target="_blank" href="https://www.toufood.com/product/agar-elastic-powdered-agar-and-gellan/?lang=en#:~:text=It%20is%20a%20combination%20of%20agar%20and%20gellan%20and%2C%20therefore,meat%20or%20100%20g%20vegetables."><strong>Agar Elastic</strong></Link>
           <div>(Powered agar and gelatine (to mend the problem that agar agar is not that elastic))</div>
           </div>
            


            <ul>
            <Link className={styles.link} target="_blank" href="(https://spark.iop.org/stretching-truth)"><strong>Super stretchy seaweed</strong></Link>
        ...
        <div className={styles.spChapter}>
            ...
            <Link className={styles.link} target="_blank" href="https://www.youtube.com/watch?v=TqXSFckqLhU">How to press and dry seaweed</Link>
            <Link className={styles.link} target="_blank"  href="https://www.verywellfit.com/seaweeds-health-claims-2223487">Seaweed nutrition</Link>
            <Link className={styles.link} target="_blank"  href="https://www.gearpatrol.com/fitness/a37779347/satisfy-running-seaweed-sustainable-performance-fabric/">A sustainable Seaweed Material</Link>
            </div>
        </div>
        ...
        <div className={styles.spChapter}>
            ...
            <Link className={styles.link} target="_blank"  href="https://alexanderclementine.com/products/seaweed-scrunchie?variant=37378936701090">seaweed scrunchie</Link>
            <Link className={styles.link} target="_blank"  href="https://www.amazon.com/Biodegradable-Elastic-Hair-Ties-Women/dp/B07QFYGZ48">Biodegradable Elastic Hair Ties Women</Link>
            <Link className={styles.link} target="_blank"  href="https://kooshoo.com/pages/about">Kooshoo</Link>
            </div>
        </div>
        ...
        <div className={styles.spChapter}>
            ...
            <strong>Library Documentation <Link className={styles.link}  target="_blank"  href="https://drive.google.com/drive/folders/16Ha6X4m-CIMJqm7W_my_uEsIBLyoAOGN">whole process</Link>
            ...
            <ul>
                ...
                <li>500ml Water and 5 ml Glycerin following this video<Link className={styles.link}  target="_blank"  href="https://www.youtube.com/watch?v=Ty0O2VmbNeE">Homemade Bioplastic: agar vs. gelatin recipe</Link></li>
        ...
        <div className={styles.spChapter}>
          ...
          <div className={styles.spChapterText}>
            <Link className={styles.link} target="_blank"  href="https://nyu.libcal.com/event/11611622?f=h">Algae knitting workshop</Link>
            <Link className={styles.link} target="_blank"  href="https://www.youtube.com/watch?v=UmcthQRWGUY">How to DIY a hair tie</Link>
            <div className={styles.imgContainer}>   
        ...
        <div className={styles.spChapter}>
          ...
          <div className={styles.spChapterText}>
            <div>
            <Link className={styles.link} target="_blank"  href="https://www.google.com/url?q=https://www.google.com/search?client%3Dsafari%26rls%3Den%26q%3Dmicroorganisms%2Bhave%2Bagarases%26ie%3DUTF-8%26oe%3DUTF-8&sa=D&source=editors&ust=1731500723352319&usg=AOvVaw2A1KsArNKK2MABSnQRvsC2">microorganisms have agarases</Link>
            <TextSplitter  text={`Degrade in the seawater and marine sediments.`} />
            </div>
            
            <div>
            <Link className={styles.link} target="_blank"  href="https://www.google.com/url?q=https://www.tandfonline.com/doi/pdf/10.1080/00021369.1983.10865852&sa=D&source=editors&ust=1731503323368912&usg=AOvVaw1yfDBx1LOD4r7qXXlvV-kK">Gelation of Gelatin Solution</Link>
        ...
        <div className={styles.spChapter}>
          ...
          <div className={styles.spChapterText}>
            <ul>
                ...
                <Link className={styles.link} target="_blank"  href="https://www.google.com/url?q=https://www.youtube.com/watch?v%3DaEIAYBGRyYY&sa=D&source=editors&ust=1731503323369557&usg=AOvVaw3yKGhkyT6-n0l7e5SXRg9e">How Rubber bands are made</Link>
