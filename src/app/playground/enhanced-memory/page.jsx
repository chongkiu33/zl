...
const Page = () => {
  ...
  <div>
        ...
        <div className={styles.spAbstract}> This project is an -omancy about “predicting” your visited websites and constructing an identity based on your browser history.</div>

        <div className={styles.spChapter}>
            <div className={styles.spChapterTitle}>Brief</div>
            <div className={styles.spChapterText}>
            Internet gradually inverts the natural forgetting to an impossible thing and brings accurate and detailed memory as a norm. For example, Google could store every search result for each user, as well as every subsequent search result that each user clicks to access. By collecting these data, it could recognize it is “your activity” even if you are searching by a different IP address or on a completely different computer.
            <br/><br/>
            This unforgettable history and its utilization scare me. If we think memory is a necessary part of our identity, then natural forgetting, as an important part of what constitutes our natural memory, should also strongly link to our identity. Our memories can be plastic, fungible, and shifting sometimes compared to what really happened. These features are all related to forgetting.
            <br/><br/>
        ...
        allowFullScreen
      ></iframe>
            The GitHub Page for historyVisitedItems is an extension for past browser history.<br/>
            The GitHub Page displays the history of a website in URL form and the website is being developed. 
            <br/>
        ...
        <div className={styles.spChapter}>
            ...
            <div className={styles.spChapterText}>
            <div>In brief, I talked about how memory could be tossed to construct a controversial identity. In this description, I will extend the memory under the social context, discussing how it could become a representation of power, violate our privacy, and question our relationship. </div>
            
            <div>In “Delete: The Virtue of Forgetting in a Virtual Age“, Mayer-Schonberger mentioned a 25-year-old single mother Stacy Snyder fails to become a teacher because of an online photo of drinking named “Drunken Pirate” on her Myspace. (Chapter 1) However, she has already reached the legal drinking age, the photos do not clearly indicate what she drank, and posting personal photos on the Social Network does not violate any teacher regulations. This reminds us, that our tradition of forgetting has been challenged. With the help of technology, “forgetting has become the exception, and the remembering the default”. </div>
        ...
        <div className={styles.spChapter}>
            ...
            <div className={styles.spChapterText}>
            <ul>
                <li>ChatGPT does not support predicting history through URLs in its normal prompt, it will continue to give me a response that it does not have access to the external website/ content.</li>
                    <ul>
                    <li>Possible Solution: Change the prompt to be the title of the URLs, or any other information of the URLs. However, before doing that, we shall ask ourselves what that element stands for in the browser history. Why it could be the best representative?Will Title or ID be a better identifier? </li> 
                    </ul>
        ...
        <div className={styles.spChapter}>
            ...
            <div className={styles.spChapterText}>
            Even though it seems we could generate a past based on history, it seems could generate the future in the same way, maybe there are more dynamics about the history and the future.
            </div>
        ...
        <div className={styles.spChapter}>
            ...
            This is how google search works. It uses the words of your query, relevance and usability of pages, expertise of sources, and locations to give you the most accurate result.
            </div>
        ...
        <div className={styles.spChapter}>
            ...
            <div className={styles.spChapterText}>
            <ul>
                <li>Viktor Mayer-Schonberger, Delete: The Virtue of Forgetting in a Virtual Age (Princeton University Presss, 2011)</li>
                <li>Ted Chiang, The Truth of Fact, the Truth of Feeling</li>
                <li>The Entire History of You (Black Mirror, season 2, episode 3)</li>
                <li>Henry Jenkins, “Enhanced Memory,” in Through the Black Mirror: Deconstructing the Side Effects of the Digital Dark Age (Palgrave Mcmillan, 2019), p. 43-47.</li>
            </ul>
            </div>
