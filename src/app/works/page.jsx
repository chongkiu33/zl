...
const works = [
    {
        ...
        description: 'Have you imagined an “artificial friend” that could recognize your emotions and support you? Now, she is coming from the website to reality. Jane could recognize your emotions and respond to you in a written note along with a caring voice. This interactive installation aims to reflect on what we need in an intimate relationship if what we need could all be satisfied by a considerate “machine.”',
